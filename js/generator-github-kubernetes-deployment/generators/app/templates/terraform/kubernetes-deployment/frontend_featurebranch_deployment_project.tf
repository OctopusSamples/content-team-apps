...
locals {
  ...
  dns_branch_name                        = "#{Octopus.Action[Frontend WebApp].Package[${local.frontend_package_id}].PackageVersion | VersionPreRelease | Replace \"\\..*\" \"\" | ToLower}"
