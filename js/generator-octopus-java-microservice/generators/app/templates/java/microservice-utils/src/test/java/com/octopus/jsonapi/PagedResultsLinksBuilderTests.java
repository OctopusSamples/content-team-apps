...
public class PagedResultsLinksBuilderTests {
  ...
  public void testLinksAreAdded() {
    ...
    PAGED_RESULTS_LINKS_BUILDER.generatePageLinks(document, "5", "3", results, "customers");
  ...
  public void verifyNullInputs() {
    ...
    assertThrows(NullPointerException.class, () -> {
      PAGED_RESULTS_LINKS_BUILDER.generatePageLinks(null, "10", "10", results, "customers");
    });
    assertThrows(NullPointerException.class, () -> {
      PAGED_RESULTS_LINKS_BUILDER.generatePageLinks(document, "10", "10", null, "customers");
    });
  }
