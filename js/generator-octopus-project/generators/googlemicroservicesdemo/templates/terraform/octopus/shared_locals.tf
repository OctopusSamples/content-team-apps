locals {
  ...
  namespace                = "matthew-casperson-onlineboutique-#{Octopus.Environment.Name | Replace \" .*\" \"\" | ToLower}"
  feature_branch_namespace = "matthew-casperson-onlineboutique-development"
