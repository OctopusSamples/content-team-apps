...
resource "github_actions_secret" "development_environment_existing" {
  ...
  count           = length(data.octopusdeploy_environments.development.environments) != 0 ? 1 : 0
}
...
resource "github_actions_secret" "development_security_environment_existing" {
  ...
  count           = length(data.octopusdeploy_environments.development_security.environments) != 0 ? 1 : 0
}
...
resource "github_actions_secret" "production_environment_existing" {
  ...
  count           = length(data.octopusdeploy_environments.production.environments) != 0 ? 1 : 0
}
...
resource "github_actions_secret" "production_security_environment_existing" {
  ...
  count           = length(data.octopusdeploy_environments.production_security.environments) != 0 ? 1 : 0
}
