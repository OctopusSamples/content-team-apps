            ...
            >
                ...
                <Grid item md={6} xs={12}>
                    ...
                    >
                        ...
                        <p>
                            The sample application is being pushed to <a href={"https://github.com/"} target={"_blank"}>GitHub</a> in a
                        ...
                        <p>
                            ...
                            name) in your <a href={getOctopusServer() + "/app#/configuration/spaces"} target={"_blank"}>Octopus instance</a> will be populated with a
                        ...
                        <p>
                            ...
                            on <a href={"https://github.com/OctopusSamples/content-team-apps/issues/13"} target={"_blank"}>this GitHub issue</a>.
                        </p>
                        <Button
                            sx={nextButtonStyle}
                            variant="outlined"
