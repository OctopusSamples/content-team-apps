resource "octopusdeploy_project" "cognito_userpool_client_project" {
  ...
  description                          = "Deploys the Jenkins Pipelines Azure Service Bus Proxy Cognito User Pool Client. Don't edit this process directly - update the Terraform files in [GitHub](https://github.com/OctopusSamples/content-team-apps/terraform) instead."
  discrete_channel_release             = false
  is_disabled                          = false
  is_discrete_channel_release          = false
  is_version_controlled                = false
  lifecycle_id                         = var.octopus_application_lifecycle_id
  name                                 = "Jenkins Pipelines Azure Service Bus Proxy Cognito User Pool Client"
