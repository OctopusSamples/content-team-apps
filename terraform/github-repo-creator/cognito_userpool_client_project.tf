resource "octopusdeploy_project" "cognito_userpool_client_project" {
  ...
  description                          = "Deploys the GitHub Commit Creator Cognito User Pool Client. Don't edit this process directly - update the Terraform files in [GitHub](https://github.com/OctopusSamples/content-team-apps/terraform) instead."
  discrete_channel_release             = false
  is_disabled                          = false
  is_discrete_channel_release          = false
  is_version_controlled                = false
  lifecycle_id                         = var.octopus_application_lifecycle_id
  name                                 = "GitHub Commit Creator Cognito User Pool Client"
...
resource "octopusdeploy_deployment_process" "cognito_userpool_client_deploy_project" {
  ...
  step {
    condition           = "Success"
    name                = "GitHub Commit Creator User Pool Client"
    package_requirement = "LetOctopusDecide"
    start_trigger       = "StartAfterPrevious"
    action {
      ...
      properties = {
        "Octopus.Action.Aws.AssumeRole": "False"
        "Octopus.Action.Aws.CloudFormation.Tags": "[{\"key\":\"Environment\",\"value\":\"#{Octopus.Environment.Name}\"},{\"key\":\"Deployment Project\",\"value\":\"GitHub Commit Creator Cognito User Pool Client\"},{\"key\":\"Team\",\"value\":\"Content Marketing\"}]"
        "Octopus.Action.Aws.CloudFormationStackName": "#{CloudFormation.OctopusCreateGithubCommitAppClient}"
        "Octopus.Action.Aws.CloudFormationTemplate": <<-EOT
          ...
          Outputs:
            ...
            EOT
        "Octopus.Action.Aws.CloudFormationTemplateParameters": "[{\"ParameterKey\":\"CognitoPoolId\",\"ParameterValue\":\"#{Octopus.Action[Get Stack Outputs].Output.CognitoPoolId}\"},{\"ParameterKey\":\"CallbackUrl\",\"ParameterValue\":\"https://example.org\"},{\"ParameterKey\":\"ResourceServerIdentifier\",\"ParameterValue\":\"audit.content-team\"},{\"ParameterKey\":\"ResourceServerName\",\"ParameterValue\":\"Github Commit Creator Microservice\"},{\"ParameterKey\":\"ScopeDescription\",\"ParameterValue\":\"Github Commit Creator administrator\"},{\"ParameterKey\":\"ScopeName\",\"ParameterValue\":\"admin\"}]"
