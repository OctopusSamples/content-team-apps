...
resource "octopusdeploy_project" "deploy_project" {
  ...
  description                          = "Deploys the GitHub Action Workflow Generator Frontend. Don't edit this process directly - update the Terraform files in [GitHub](https://github.com/OctopusSamples/content-team-apps/terraform) instead."
  ...
  included_library_variable_sets = [
    octopusdeploy_library_variable_set.library_variable_set,
