resource "octopusdeploy_library_variable_set" "frontend_library_variable_set" {
  ...
  description = "Variables used when deploying the App Builder shared infrastructure. Don't edit these variables directly - update the Terraform files in [GitHub](https://github.com/OctopusSamples/content-team-apps/terraform) instead."
}
