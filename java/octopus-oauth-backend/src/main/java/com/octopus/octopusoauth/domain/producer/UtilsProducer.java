package com.octopus.octopusoauth.domain.producer;
...
import com.octopus.http.impl.FormBodyParserImpl;
...
public class UtilsProducer {
  ...
  /**
   * Produces the form body parser utils instance.
   *
   * @return An implementation of getFormBodyParser.
   */
  @ApplicationScoped
  @Produces
  public FormBodyParser getFormBodyParser() {
    return new FormBodyParserImpl();
  }
}
