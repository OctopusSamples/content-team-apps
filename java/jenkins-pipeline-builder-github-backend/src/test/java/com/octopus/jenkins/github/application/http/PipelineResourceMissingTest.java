...
public class PipelineResourceMissingTest {
  ...
  public void setup() {
    Mockito.when(repoClientFactory.buildRepoClient(any(), any()))
        .thenReturn(new RepoClient() {
          ...
          /**
           * Report that the access token has been set.
           * @return always true
           */
          @Override
  ...
  /**
   * When the repo can not be accessed and an accesstoken has not provided, we report
