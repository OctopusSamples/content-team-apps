...
public class PopulateGithubRepoApi implements
  ...
  /**
   * Create a github commit. Note this endpoint returns a 202, as the actual commit is created in an
   * async operation after this request has returned. The returned entity contains the details of
   * the repo that the commit will be placed into.
   *
