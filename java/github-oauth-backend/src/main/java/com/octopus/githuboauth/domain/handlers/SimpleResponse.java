...
public class SimpleResponse {
  ...
  public SimpleResponse(final int code, final Map<String, String> headers, final Map<String, List<String>> multiValueHeaders) {
  ...
  public SimpleResponse(final int code, final String body, final Map<String, String> headers, final Map<String, List<String>> multiValueHeaders) {
    this.code = code;
    this.body = body;
